...
namespace test.Cards
{
    public sealed class StSOverclockDef : CardTemplate
    {
        ...
        public override CardConfig MakeConfig()
        {
            var cardConfig = new CardConfig(
               ...
               RelativeCards: new List<string>() { "Riguang" },
               UpgradedRelativeCards: new List<string>() { "Riguang" },
               Owner: null,
               Unfinished: false,
    ...
    [EntityLogic(typeof(StSOverclockDef))]
    public sealed class StSOverclock : Card
    {
        protected override IEnumerable<BattleAction> Actions(UnitSelector selector, ManaGroup consumingMana, Interaction precondition)
        {
            ...
            yield return new AddCardsToDiscardAction(Library.CreateCards<Riguang>((int)Math.Truncate((double)num / base.Value1), false));
            yield break;
        }
    }
}*/