...
namespace StSStuffMod.Cards
{
    public sealed class StSNecronomicurseDef : CardTemplate
    {
        ...
        {
            return nameof(StSNecronomicurse);
        }
        ...
        public override CardConfig MakeConfig()
        {
            var cardConfig = new CardConfig(
               ...
               Keywords: Keyword.Unremovable | Keyword.Forbidden,
               ...
               SubIllustrator: new List<string>() { "ZUN" }
            );

            return cardConfig;
        }
    }
    [EntityLogic(typeof(StSNecronomicurseDef))]
    public sealed class StSNecronomicurse : Card
    {
